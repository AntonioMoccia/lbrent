...
function Hero({ image, h1, p, fullScreen = true }: HeroProps) {
  ...
  return (
    <>
      <section
        className={` py-6 rounded-t-3xl gap-5 bg-black flex items-center text-white h-[calc(100vh-5rem)] max-h-[calc(100vh-5rem)] min-h-[600px] justify-around lg:justify-around flex-col`}
      >
